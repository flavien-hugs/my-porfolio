...
export const projects: Project[] = [
	{
		...
		highlights: [
			{ en: 'Unified interface for multiple gateways', fr: 'Interface unifiée pour plusieurs passerelles' },
			{ en: 'Zero external dependencies', fr: 'Zéro dépendance externe' },
			{ en: 'Clean architecture & extensible design', fr: 'Architecture propre et design extensible' }
		],
		architecture: [
	...
	},
	{
		...
		highlights: [
			{ en: 'Lead mapping and pipeline tracking', fr: 'Cartographie des prospects et suivi du pipeline' },
	...
	},
	{
		...
		architecture: [
			{ en: 'Classic Django MTV', fr: 'Django MTV Classique' }
		]
	},
	{
	...
	},
	{
		...
		highlights: [
			...
			{ en: 'Score tracking & difficulty scaling', fr: 'Suivi de score & progression de difficulté' }
		],
		architecture: [
